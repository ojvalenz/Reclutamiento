  ...
  export default {
    ...
    methods: {
      ...
      fnGetCatalogsVacante() {
        const self = this;
        this.$http(self, '/vacantes/vacante/new', this.Constants.HTTPmethod.GET, null, this.Constants.ContentType.URL, this.Constants.ResponseType.JSON,
          function (response) {
      ...
      fnGetVacante() {
        const self = this;
        this.$http(self, '/vacantes/' + this.$route.params.id_vacante, this.Constants.HTTPmethod.GET, null, this.Constants.ContentType.URL, this.Constants.ResponseType.JSON,
          function (vacantes) {
        ...
        this.$validator.validate().then(valid => {
          if (valid) {
            ...
            if (isEmpty(this.vacante.id_vacante)) {
              this.$http(self, '/vacantes', this.Constants.HTTPmethod.POST, this.vacante, this.Constants.ContentType.JSON, this.Constants.ResponseType.JSON,
                function (response) {
              ...
              this.$http(this, '/vacantes', this.Constants.HTTPmethod.PUT, this.vacante, this.Constants.ContentType.JSON, this.Constants.ResponseType.JSON,
                function (response) {
